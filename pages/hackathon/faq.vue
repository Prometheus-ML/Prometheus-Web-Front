...
const faq = ref({
  ...
  "평가 기준" : [
    {
      title: '예선 평가 기준은 어떻게 되나요?',
      value: '예선에서는 서비스 기획안에 대한 평가가 진행됩니다.',
      on: false,
    },
    {
      title: '본선 평가 기준은 어떻게 되나요?',
      value: '본선에서는 앱, 앱 프로토타입에 대한 평가가 진행됩니다.',
      on: false,
    },
  ],
  "팀빌딩" : [
    {
      title: '개인 지원도 가능한가요?',
      value: '아니요, 개인 지원은 불가합니다. 최소 4명~5명의 인원으로 팀원을 구성하셔서 지원해주셔야 합니다.',
      on: false,
    },
    {
