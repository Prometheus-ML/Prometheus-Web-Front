  ...
  "본선" : [
    {
      ...
      value: '본선에서는 기획안과 앱, 웹 프로토타입을 바탕으로 심사합니다.',
      on: false,
    },
    {
    ...
    },
    {
      ...
      value: '모델 구축과 학습, 앱 및 웹 프로토타입 모두 현장에서 직접 하셔야하며 본선시작 전 제작한 모든 결과물들은 모두 부정행위로 간주될 수 있습니다. 주제에 대한 아이디어 스케치 정도에 한해서만 허용됩니다. ',
      on: false,
    },
  ],
  "기타" : [
