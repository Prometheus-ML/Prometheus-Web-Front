<template>
  ...
  <div class="container mx-auto pt-48">
    <div>
      <p class="font-bold text-6xl mb-9">Member</p>
      ...
      <div class="p-16">
        <ul class="flex flex-wrap justify-center gap-9">
          ...
          <li class="w-64 text-center">
            ...
            <p class="text-l mb-2">한국외국어대학교 컴퓨터공학부</p>
          </li>
          <li class="w-64 text-center">
            <img
          ...
          <li class="w-64 text-center">
            ...
            <p class="text-l mb-2">
              연세대학교 언더우드국제대학, 경제학 전공, 컴퓨터과학 복수전공
            </p>
          </li>
        </ul>
      </div>
      ...
      <div class="p-16">
        <ul class="flex flex-wrap justify-center gap-9">
          ...
          <li class="w-64 text-center">
            ...
            <p class="text-l mb-2">
              한양대학교 경영학부, 빅데이터융합학부 / KB국민은행 데이터 직무
            </p>
          </li>
          <li class="w-64 text-center">
            <img
            ...
            <p class="text-l mb-2">한양대학교 철학과 / 스타트업 백엔드 인턴</p>
          </li>
          <li class="w-64 text-center">
            <img
          ...
          <li class="w-64 text-center">
            ...
            <p class="text-l mb-2">
              덕성여자대학교 수학과, 정보통계학과 / LINE 데이터 분석 직무
            </p>
          </li>
          <li class="w-64 text-center">
            <img
            ...
            <p class="text-l mb-2">
              한양대학교 생체공학과 / 서울대학교 뇌인지과학과 석사 과정
            </p>
          </li>
          <li class="w-64 text-center">
            <img
          ...
          <li class="w-64 text-center">
            ...
            <p class="text-l mb-2">상명대학교 컴퓨터과학과</p>
          </li>
          <li class="w-64 text-center">
            <img
            ...
            <p class="text-l mb-2">한양대학교 인공지능학과 석사과정</p>
          </li>
          <li class="w-64 text-center">
            <img
            ...
            <p class="text-l mb-2">한양대학교 수학과 / NAVER 취업</p>
          </li>
          <li class="w-64 text-center">
            <img
            ...
            <p class="text-l mb-2">고려대학교 신소재공학부</p>
          </li>
        </ul>
      </div>
      <hr />
