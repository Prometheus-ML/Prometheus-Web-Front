<template>
  <div class="relative w-screen h-screen mb-10 lg:mb-20">
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      ...
      <p class="md:text-4xl text-2xl text-center text-white transition-opacity duration-500 ease-in mb-2">2024 HACKATHON</p>
      <p class="text-sm text-center text-red-700 transition-opacity duration-500 ease-in">12월 18일 공개 예정</p>
    </div>
