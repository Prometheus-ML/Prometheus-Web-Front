								...
								<div class="relative">
										...
										>
												...
												<div v-if="member.hover" class="absolute bg-gray-800 opacity-80 top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center overflow-visible">
														...
														<font-awesome-icon @click="deleteMember(member)" class="absolute top-1 right-1 cursor-pointer z-50 mr-1 hover:opacity-70 py-1 px-2 text-rose-600" icon="fa-solid fa-xmark"/>
														<font-awesome-icon @click="showEditForm(member.id)" class="absolute bottom-0 right-0 cursor-pointer z-50 mr-1 hover:opacity-70 py-1 px-2" icon="fa-solid fa-pen"/>
												</div>
										</div>
